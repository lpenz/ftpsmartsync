...
<H1>DESCRIPTION</H1>
<P>
<B>ftpsync</B> is a program that synchronizes all files beneath the current
...
<P>
The password is found by looking at <I>~/.netrc</I>, see <B>netrc</B>(5).
...
<P>
<B>-s</B> Safe mode: sends hashes.txt after every successful file transfer.
</P>
<H1>AUTHORS</H1>
<P>
